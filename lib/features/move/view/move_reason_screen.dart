...
class _MoveReasonScreenState extends State<MoveReasonScreen> {
  ...
  Widget build(BuildContext context) {
    List<String> listOfDropDown = ['Completed', 'Sold Out', 'Dispatched', 'By Air','Completed 1', 'Sold Out 1', 'Dispatched 1', 'By Air 1'];
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        backgroundColor: Colors.white,
        title:  AppText('Move Folder', style: TextStyle().defaultTextStyle(fontSize: 20)),
      ),
      body: Padding(
          ...
          children: [
            ...
            // AppText("Do you want to move ${widget.selectedFolder.name} to 'Folder 2'?", maxLines: 3, style: TextStyle(fontSize: 16)),
             Padding(
              ...
              child: AppText("Select Reason to Move (Optional)", maxLines: 3, style: const TextStyle().defaultTextStyle()),
            ),
                      ...
                      items: [
                        ...List.generate(
                          ...
                          (index) => DropdownMenuItem(
                            ...
                            child: AppText(listOfDropDown[index],style: TextStyle().defaultTextStyle(),),
                          ),
                        ),
                      ],
                      onChanged: (s) {
