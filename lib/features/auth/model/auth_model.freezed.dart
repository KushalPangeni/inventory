...
class _$AuthResponseImpl implements _AuthResponse {
  ...
  @override
  String toString() {
    return 'AuthResponse(result: $result, count: $count, message: $message, status: $status)';
  }
...
abstract class _AuthResponse implements AuthResponse {
  factory _AuthResponse(
      ...
      required final int status}) = _$AuthResponseImpl;
...
class _$ResultImpl implements _Result {
  _$ResultImpl({this.token = '', this.user});
...
abstract class _Result implements Result {
  factory _Result({final String? token, final User? user}) = _$ResultImpl;
...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String email, List<String?> role});
}
...
class _$UserImpl implements _User {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, email, const DeepCollectionEquality().hash(_role));
...
abstract class _User implements User {
  factory _User(
      ...
      final List<String?> role}) = _$UserImpl;
