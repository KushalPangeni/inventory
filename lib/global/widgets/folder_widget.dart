...
class FolderWidget extends StatelessWidget {
  ...
  const FolderWidget({super.key, required this.folder, this.parentFolderId, required this.onPop});
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Image.asset('assets/folder.png', height: 80, width: 85),
                ),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          AppText('000${folder.id}', style: const TextStyle().defaultTextStyle(fontSize: 12)),
                    ...
                    IconButton(
                        onPressed: () {
                          FolderItemMoreBottomModalSheet(context, folder, folder.id, parentFolderId, () {
                            onPop();
